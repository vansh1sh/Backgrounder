...
public class CameraRecorder extends Activity implements SurfaceHolder.Callback {
    ...
    private ScreenReceiver reciever;
...
//		registerReceiver(mReceiver, filter);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                registerReceiver(reciever,screenOnFilter);
    ...
    protected void onPause() {
        ...
        /*if (ScreenReceiver.wasScreenOn) {
            Intent intent = new Intent(CameraRecorder.this, RecordService.class);
    ...
    protected void onResume() {
       ...
       /* if (!ScreenReceiver.wasScreenOn) {
            if (getIntent().getAction().equals(Intent.ACTION_SCREEN_ON)) {
                stopService(new Intent(CameraRecorder.this, RecordService.class));
